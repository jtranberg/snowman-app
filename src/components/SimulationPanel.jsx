  ...
  return (
    <div className="simulation-panel">
      ...
      <div className="sim-grid">
        ...
        <div className="stat-card"><span className="label">secret</span><span className="value">{data.oxygen_before}%</span></div>
        <div className="stat-card"><span className="label">secret</span><span className="value">+{data.oxygen_added}%</span></div>
        <div className="stat-card"><span className="label">xx After</span><span className="value">{data.oxygen_after}%</span></div>
        <div className="stat-card"><span className="label">xxx Temp</span><span className="value">{data.temp_after_manifold} °C</span></div>
        <div className="stat-card"><span className="label">xxx Temp</span><span className="value">{data.cooled_temp} °C</span></div>
        ...
        <div className="stat-card"><span className="label">xxx</span><span className="value">{data.minerals_captured_kg.toFixed(3)} kg</span></div>
      </div>
       {/* <div className="sim-grid">
        <div className="stat-card"><span className="label">Ambient Temp</span><span className="value">{data.ambient_temp} °C</span></div>
